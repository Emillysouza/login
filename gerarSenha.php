<?php 
    if(isset($_GET['token']) && isset($_GET['email'])){
        ...
        $token = $_GET['token'];
        $msg ="$email : $token";
        //so para testar metodo GET
        //http://localhost/login/index.php?token=12345678900@email=Emillysouza@gmail.com
    ...
    <main class="container">
        <section class="row justify-content-center">
            <div class="col-lg-5 mt-5">
                <h3 class="text-center bg-dark text-ling p-2 rounded">
                ...
                <form action="" method="post">
                    ...
                    <div class="form-group">
                        <label for="csenha">Confirma a Nova senha</label>
                        <input type="password" name="csenha" id="csenha" class="form-control" 
                        placeholder="Confirma a Nova senha" required>
                    </div>
                    <div class="form-group">
