            ...
            <div class="col-lg-4 offset-lg-4 bg-light rounded" id="caixaLogin">
                ...
                <form action="#" method="post" class="p-2" id="formLogin">
                    ...
                    <div class="form-group">
                        <input type="text" name="nameUsuario" id="nomeUsuario" placeholder="Nome de Usuário" class="form-control" required minlenght="5">

                    </div>

                    <div class="form-group">
                        <input type="password" name="senhaUsuario" id="senhaUsuario" placeholder="senha" class="form-control" required minlenght="6">
        ...
        <Section class="row mt-5">
            <div class="col-lg-4 offset-lg-4 bg-light rounded" id="caixaRegistro">
                ...
                <form action="#" method="post" class="p-2" id="formRegistro">
                    ...
                    <div class="form-group">
                        <input type="password" name="senhaUsuarioConfirmar" id="senhaUsuarioConfirmar" class="form-control" placeholder="Confirma senha" required minlength="6">
                    </div>
