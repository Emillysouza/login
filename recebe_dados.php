...
if($_POST['action'] == 'cadastro'){
    ...
    if($senhaCodificada != $senhaConfirmarCod){
        ...
        $linha =$resultado->fetch_array(MYSQL1_ASSOC);
        //verifique a existencia do usuario no banco
        ...
        $sql->bind_param("ssss", $nomeDoUsuario, $nomeCompleto, $emailUsuario, $senhaCodificada, $dataCriado);
        if($sql->execute()){
